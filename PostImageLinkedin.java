...
public class PostImageLinkedin {
    ...
    public  void testCase01() throws InterruptedException{
        ...
        Thread.sleep(3000);
        // In the "Sign in" page, enter username Using Locator "ID" username | sendkeys("suryaprakashreddy")
        driver.findElement(By.id("username")).sendKeys("natlasuryaprakash11@gmail.com");
        Thread.sleep(3000);
